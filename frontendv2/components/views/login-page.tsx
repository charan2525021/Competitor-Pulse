...
import { Zap, Eye, EyeOff, LogIn, AlertCircle, CheckCircle2 } from "lucide-react"
...
export function LoginPage({ onLogin, onSwitchToSignup, verifiedStatus }: LoginPageProps) {
      ...
      <Card className="w-full max-w-md relative z-10">
        <CardContent className="p-8">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-sm text-muted-foreground">Sign in to CompetitorPulse</p>
          </div>
